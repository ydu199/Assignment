...
First, using the rbeta function to generate 2000 random variables between 0 and 5. The distribution of population x is left-skewed.
```{r}
set.seed(123)
x=rbeta(2000,5,2)*5
hist(x, freq=FALSE)
...
We take 1000 samples from the population x and use 4 sample sizes: 100, 150, 200, 500. As the size gets larger, the curve becomes closer to the normal distribution.
```{r}
n<-1000
samplesize1<-100
xbar1<-rep(NA,n)
